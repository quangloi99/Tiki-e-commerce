...
headers = {
    ...
    'Referer': 'https://tiki.vn/dien-tu-dien-lanh/c4221',
...
params = {
    ...
    'aggregations': '2',
    'trackity_id': '0891a72c-6dc9-c1a6-da4e-3f4d54e3c211s',
    'category': '4221',
    'page': '1',
    'src': 'c1883',
...
df.to_csv(f'product_id_dientu({datetime.now().strftime("%d-%m-%Y")}).csv', index=False)
